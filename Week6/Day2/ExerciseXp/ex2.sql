...
SELECT  first_name, last_name, amount, payment_date FROM customer INNER JOIN payment ON customer.customer_id = payment.customer_id ORDER BY payment.customer_id
...
SELECT * from payment
SELECT first_name, last_name, payment.customer_id, amount, payment_date, staff_id FROM  customer INNER JOIN payment ON customer.customer_id = payment.customer_id ORDER BY staff_id